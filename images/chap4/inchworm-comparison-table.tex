...
\begin{tabular}{p{3.25cm}P{1cm}P{1.5cm}P{1.25cm}P{1.25cm}P{1.5cm}P{1.75cm}}
 % \begin{tabu} to 1\textwidth {X[l, 2] X[l, 0.75] X[l,0.75] X[l,1] X[l,1] X[l,1.25]}
   ...
   \rowcolor{black} \textbf{\color{white} \makecell[tl]{Smart Material\\Technology}} & \textbf{\color{white} Tether} & \textbf{\color{white} Robot length (BL) [mm]} & \textbf{\color{white} Speed [mms$^{-1}$]} & \textbf{\color{white} Speed [BLs$^{-1}$]} & \textbf{\color{white} Total weight [g]}  & \textbf{\color{white} Speed / weight [BLs$^{-1}$ per g]}\\
