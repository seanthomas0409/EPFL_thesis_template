...
% [every node/.style={inner sep=0,outer sep=60}]
    ...
    \begin{scope}[x={(dsc.south east)},y={(dsc.north west)}]
        ...
        \node [anchor=center] (hheating) at (0.66,0.74) {\large $\Delta H_\mathrm{heating}$};
        \node [anchor=center] (hcooling) at (0.34,0.26) {\large $\Delta H_\mathrm{cooling}$};

        \node [anchor=center] (MA) at (0.67,1.03) {\large $M\rightarrow A$};
        \node [anchor=center] (AM) at (0.33,-0.03) {\large $M\leftarrow A$};

        \node [anchor=center] (mf) at (0.22,0.41) {\large $M_f$};
        \node [anchor=center] (ms) at (0.47,0.41) {\large $M_s$};

        \node [anchor=center] (af) at (0.78,0.59) {\large $A_f$};
        \node [anchor=center] (as) at (0.535,0.59) {\large $A_s$};
