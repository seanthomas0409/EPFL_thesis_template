...
\begin{figure}[hbt!] % t for top of the page, H could be put to impose the position of the float
  \centering
  \resizebox{0.75\textwidth}{!}{\input{images/chap4/sma-osc-latch-wp.pgf}}
...
\begin{figure}[htb!] % t for top of the page, H could be put to impose the position of the float
  ...
  \begin{tikzpicture}
    \begin{scope}[x={(graph.south east)},y={(graph.north west)}]
        \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.66\textwidth]{images/chap6/proto-full.jpg}};
    \end{scope}
  \end{tikzpicture}%
...
\subsection{Sizing of the oscillator}\label{subsec:thermal-sizing}
...
\begin{figure}[htb!] % t for top of the page, H could be put to impose the position of the float
  \centering
  \resizebox{0.65\textwidth}{!}{\input{images/chap6/cooling-time-extrapolation.pgf}}
  % \begin{tabular}{r@{ : }l r@{ : }l}
  %   \fcolorbox{black}{myblue}{\rule[1pt]{0pt}{6pt}\rule[1pt]{6pt}{0pt}} & 340 mA & \fcolorbox{black}{myred}{\rule[1pt]{0pt}{6pt}\rule[1pt]{6pt}{0pt}} & 840 mA
  % \end{tabular}
...
%%%%%%%% Design Methodology Oscillator %%%%%%%%%%%
\begin{figure}[hbt!] % t for top of the page, H could be put to impose the position of the float
  \centering
  \input{images/chap4/mechanical-intelligence-control-flowchart.tex}
...
\begin{figure}[hbt!] % t for top of the page, H could be put to impose the position of the float
  ...
  \caption[The working principle of the insect robot showing the simplification of the cantilever beam to a virtual rigid body pivot]{The working principle of the insect robot showing the simplification of the cantilever beam to a virtual rigid body pivot. The claw design changes the coefficient of friction ($\mu_s$) of the insect with respect to the ground allowing the robot to crawl.}
  \label{fig:insect-claw-diagram}
\end{figure}

The pseudo-rigid-body model, as described in the work by \cite{howellHandbookCompliantMechanisms2013}, is used to model flexure-based mechanisms such that the cantilever beam is simplified as traditional rigid-body mechanisms. Thus, by simplifying the cantilever leaf spring as a virtual pivot, an analytical model can be established to estimate the effect of the SMA coil contraction. In the work by \cite{zhangRealPivotStructure2007}, the location of the virtual pivot can be estimated with relative accuracy to a point at a distance of $aL$ from the clamped end of the cantilever beam, where $L$ is the length of the beam, $bL$ is the length of the rigid attachment point with the SMA coil and $a$ is:
...
\begin{figure}[hb!] % t for top of the page, H could be put to impose the position of the float
  \centering
  \resizebox{0.75\columnwidth}{!}{\input{images/chap6/insect-am-fem-compare.pgf}}
...
\begin{figure}[hbt!] % t for top of the page, H could be put to impose the position of the float
  \centering
  \resizebox{0.75\columnwidth}{!}{\input{images/chap6/insect-disp.pgf}}
  % \begin{tabular}{r@{ }l r@{ }l}
  %   {\color{myblue} \rule[2pt]{10pt}{0.5mm} } & 340 mA & {\color{myred} \rule[2pt]{10pt}{0.5mm} } & 840 mA
  % \end{tabular}
...
\begin{figure}[hbt!] % t for top of the page, H could be put to impose the position of the float
  \centering
  \resizebox{0.9\columnwidth}{!}{\input{images/chap4/inchworm-speed-weight-comparison.pgf}}
  % \begin{tabular}{r@{ }l r@{ }l}
  %   {\color{myblue} \rule[2pt]{10pt}{0.5mm} } & 340 mA & {\color{myred} \rule[2pt]{10pt}{0.5mm} } & 840 mA
  % \end{tabular}
...
\begin{figure}[hbt!] % t for top of the page, H could be put to impose the position of the float
  \centering
  \resizebox{0.9\columnwidth}{!}{\input{images/chap4/inchworm-weight-speedweight-comparison.pgf}}
  % \begin{tabular}{r@{ }l r@{ }l}
  %   {\color{myblue} \rule[2pt]{10pt}{0.5mm} } & 340 mA & {\color{myred} \rule[2pt]{10pt}{0.5mm} } & 840 mA
  % \end{tabular}
...
\begin{table}[htp!]
 ...
 \input{images/chap4/inchworm-comparison-table.tex}
\end{table}
% \end{landscape}
