...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mainmatter
\include{main/ch0_introduction}
% \cleardoublepage
% \part{Body 1}
\include{main/ch1_sma_actuators}
% \cleardoublepage
% \part{Body 2}
\include{main/ch2_modelling}
\include{main/ch3_design_method}
\include{main/ch4_oscillator}
\include{main/ch5_compliant_sma}
\include{main/ch6_1_case_study_mandrel}
\include{main/ch6_2_case_study_buckled_beam}
