...
% \cleardoublepage
% \part{Body 1}
\include{main/ch2_shape_memory_alloys}
\include{main/ch3_modelling}
% \cleardoublepage
% \part{Body 2}
\include{main/ch4_control}
\include{main/ch5_buckled_beam}
\include{main/ch6_oscillator}
\include{main/ch7_bias_compliant}
\include{main/ch8_compliant_sma}
\include{main/ch9_kirigami}
\include{main/ch10_induction_heating}
\include{main/ch11_conclusion}
