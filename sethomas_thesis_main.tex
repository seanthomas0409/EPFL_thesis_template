...
\include{main/ch3_sma_actuators}
% \cleardoublepage
% \part{Body 2}
\include{main/ch4_modelling}
\include{main/ch5_oscillator}
\include{main/ch6_bias_compliant}
\include{main/ch7_buckled_beam}
\include{main/ch8_compliant_sma}
\include{main/ch9_kirigami}
\include{main/ch10_conclusion}
